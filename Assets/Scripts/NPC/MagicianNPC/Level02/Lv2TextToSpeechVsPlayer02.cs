...
using TMPro;
public class Lv2TextToSpeechVsPlayer02 : MonoBehaviour
{
    EdenAIApi edenAI;
    public TMP_Text textToSpeech;
    public AudioSource audioSource; // Thêm một AudioSource vào để phát lại âm thanh
    private string text1 = "Hiện tại người dân đã di tản hết còn vài người anh dũng chiến đấu nhưng không khả quan ta cũng đã đến giới hạn nhưng ta đã biết được tên cầm đầu của bọn chúng ở phía toà nhà cổ";
