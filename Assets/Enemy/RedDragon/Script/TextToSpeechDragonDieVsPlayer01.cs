...
using TMPro;
public class TextToSpeechDragonDieVsPlayer01 : MonoBehaviour
{
    EdenAIApi edenAI;
    public TMP_Text textToSpeech;
    public AudioSource audioSource; // Thêm một AudioSource vào để phát lại âm thanh
    private string text1 = "Vậy người dân thị trấn bỏ chạy về bìa rừng này là vì nguyên nhân này sao lời tiên tri của pháp sư cô đơn là thật";
