...
using TMPro;
public class TextToSpeechBossVsPlayer : MonoBehaviour
{
    EdenAIApi edenAI;
    public TMP_Text textToSpeech;
    public AudioSource audioSource; // Thêm một AudioSource vào để phát lại âm thanh
    private string text1 = "Ngươi đã tiêu diệt tay sai của ta, đích thân ta sẻ tiêu diệt ngươi và xâm chiếm toàn thị trấn này";
