...
using TMPro;
public class Lv2TextToSpeechVsPlayer03 : MonoBehaviour
{
    EdenAIApi edenAI;
    public TMP_Text textToSpeech;
    public AudioSource audioSource; // Thêm một AudioSource vào để phát lại âm thanh
    private string text1 = "Hắn là tên đầu não của bọn chúng và hãy thận trọng lính tay sai của chúng rất đông";
