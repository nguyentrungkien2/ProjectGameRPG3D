...
using TMPro;
public class TextToSpeechMagicianNPC02 : MonoBehaviour
{
    EdenAIApi edenAI;
    public TMP_Text textToSpeech;
    public AudioSource audioSource; // Thêm một AudioSource vào để phát lại âm thanh
    private string text1 = "được nhưng ngươi cần thông não ta bằng những lời lẽ và triết lí bởi vì cốt truyện và vì ngươi là nhân vật chính";
