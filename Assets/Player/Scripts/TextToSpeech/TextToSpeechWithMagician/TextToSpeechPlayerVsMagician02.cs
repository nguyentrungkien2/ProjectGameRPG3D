...
using TMPro;
public class TextToSpeechPlayerVsMagician02 : MonoBehaviour
{
    EdenAIApi edenAI;
    public TMP_Text textToSpeech;
    public AudioSource audioSource; // Thêm một AudioSource vào để phát lại âm thanh
    private string text1 = "Tôi không thể để bạn bè người dân bị quái vật tấn công tôi sẵn sàng hi sinh bản thân mình";
