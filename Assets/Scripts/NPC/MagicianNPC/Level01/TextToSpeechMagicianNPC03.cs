...
using TMPro;
public class TextToSpeechMagicianNPC03 : MonoBehaviour
{
    EdenAIApi edenAI;
    public TMP_Text textToSpeech;
    public AudioSource audioSource; // Thêm một AudioSource vào để phát lại âm thanh
    private string text1 = "thật cảm động nghe giống nhân vật chính rồi đấy, đây là thanh kiếm của sự khởi đầu ngươi có thể lấy nó và vượt qua thử thách của ta";
