...
using TMPro;
public class TextToSpeechVsDragonDie03 : MonoBehaviour
{
    EdenAIApi edenAI;
    public TMP_Text textToSpeech;
    public AudioSource audioSource; // Thêm một AudioSource vào để phát lại âm thanh
    private string text1 = "Cảm ơn ngươi đã tin tưởng ta nhất định không để tiềm tin của mọi người chở nên vô nghĩa ta đi đây";
