...
using TMPro;
public class TextToSpeechDragonVsPlayer02 : MonoBehaviour
{
    EdenAIApi edenAI;
    public TMP_Text textToSpeech;
    public AudioSource audioSource; // Thêm một AudioSource vào để phát lại âm thanh
    private string text1 = "Dám gọi ta là Con Thằn lằn ta là rồng đỏ Senpai người đời gọi ta với nick name là Senpai Chan";
