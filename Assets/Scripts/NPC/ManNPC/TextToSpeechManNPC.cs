...
using TMPro;
public class TextToSpeechManNPC : MonoBehaviour
{
    EdenAIApi edenAI;
    public TMP_Text textToSpeech;
    public AudioSource audioSource; // Thêm một AudioSource vào để phát lại âm thanh
    private string text1 = "Chào Nhi tôi biết phù thuỷ cô đơn ở đâu tôi sẻ chỉ cho bạn, bạn hãy đến nhà của ông ta phía bên kia cây cầu, bạn có thể đi theo mũi tên hướng dẫn màu xanh lam ở chân";
